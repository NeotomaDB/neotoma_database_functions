...
| - | -------------------- | ------------------------------ | --------------------------------------------------------------------- | -------- | ------------------------------------------------- | ------- | ----------------------------------------------------------- |
| 1 | aggregateordertype   | varchar(64)                    |                                                                       | false    |                                                   |         | The Aggregate Order Type.                                   |
| 2 | aggregateordertypeid | integer                        | nextval('ndb.seq_aggregateordertypes_aggregateordertypeid'::regclass) | false    | [ndb.aggregatedatasets](ndb.aggregatedatasets.md) |         | An arbitrary Aggregate Order Type identification number.    |
