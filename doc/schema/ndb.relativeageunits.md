...
| 3 | relativeageunit   | varchar(64)                    |                                                                 | false    |                                         |         | Relative Age Unit. Below are the Relative Age Units for the «Geologic time scale» with an example Relative Age. |
| 4 | relativeageunitid | integer                        | nextval('ndb.seq_relativeageunits_relativeageunitid'::regclass) | false    | [ndb.relativeages](ndb.relativeages.md) |         | An arbitrary Relative Age Unit identification number.                                                           |
