...
| 2 | stewardid  | integer |         | false    |          | [ti.stewards](ti.stewards.md)                           |         |
...
| 2 | fk_stewarddatabases_stewards             | FOREIGN KEY | FOREIGN KEY (stewardid) REFERENCES ti.stewards(stewardid) ON UPDATE CASCADE ON DELETE CASCADE                |
| 3 | stewarddatabases_pkey                    | PRIMARY KEY | PRIMARY KEY (stewardid, databaseid)                                                                          |
