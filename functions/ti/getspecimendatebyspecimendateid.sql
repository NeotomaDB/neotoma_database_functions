CREATE OR REPLACE FUNCTION ti.getspecimendatebyspecimendateid(_specimendateid integer)
 RETURNS TABLE(specimenid integer, taxonid integer, taxonname text, elementtypeid integer, elementtype character varying, fractionid integer, fraction character varying, sampleid integer, notes character varying)
 LANGUAGE sql
AS $function$
